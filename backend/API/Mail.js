...
async function MailSender(mail){
    const mailAddress = "sender's email"; // sender's Mail
    const mailPassword = "sender's password"; // The password This Account
    ...
    return new Promise((resolve) => {
        ...
        from : `"Unknown" <Your email>`, // The sender's inform
